    ...
    <div style="margin: 0 18px; text-align: left; padding: 10px; border-radius: 10px;">
      ...
      <el-form :model="formData" label-width="100px" label-position="left" class="custom-form">
        <div style="display: flex; gap: 20px; margin-bottom: 0;">
          <el-form-item label="配置名称" prop="name" style="flex: 1;">
            <el-input v-model="formData.name" placeholder="请输入配置名称" class="custom-input-bg"></el-input>
          </el-form-item>
          <el-form-item label="配置值" prop="value" style="flex: 1;">
            <el-input v-model="formData.value" placeholder="请输入配置值" class="custom-input-bg"></el-input>
          </el-form-item>
        </div>
      </el-form>
    </div>
