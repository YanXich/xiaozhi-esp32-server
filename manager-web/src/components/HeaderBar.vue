  ...
  <el-header class="header">
    <div class="header-container">
      ...
      <div class="header-center">
        ...
        <!-- 1101新增 设备管理 -->
        <div v-if="isSuperAdmin" class="equipment-management" :class="{ 'active-tab': $route.path === '/device-config' }"
          @click="goDeviceConfig">
          <img loading="lazy" alt="" src="@/assets/header/firmware_update.png"
            :style="{ filter: $route.path === '/device-config' ? 'brightness(0) invert(1)' : 'None' }" />
          设备配置
        </div>
